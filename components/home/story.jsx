...
export default function Story({ listStory }) {
  return (
    <section className="global__sections section-4__items featured">
      ...
      {listStory.map((elm, index) => (
        <ItemFeatured key={index} data={elm} />
      ))}
    </section>
  );
}
